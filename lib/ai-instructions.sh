...
setup_ai_instructions() {
  ...
  if [[ ! -f "$REPO_ROOT/ai/AI_INSTRUCTIONS.md" ]]; then
    log_error "AI instructions file not found at $REPO_ROOT/ai/AI_INSTRUCTIONS.md"
    return 1
  fi
  ...
  local source_file="$REPO_ROOT/ai/AI_INSTRUCTIONS.md"
